...
function ProgressBar({ data }) {
    ...
    return (
        <Card className="w-[300px] h-[120px] bg-white/50 shadow-md rounded-lg p-4 flex flex-col border-0" >
            <CardHeader>
            ...
            <CardContent className="flex flex-col items-center pb-0">
                <div className="w-[200px] bg-gray-200 rounded-full h-4 dark:bg-gray-500">
                    <div
